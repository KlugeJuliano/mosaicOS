...
MODULE_SEARCH_PATH="${MODULE_SEARCH_PATH:-$LAB_CONF_DIR:$EXPERIMENTS_DIR/hello:$EXPERIMENTS_DIR/init:$EXPERIMENTS_DIR/log:$EXPERIMENTS_DIR/status:$EXPERIMENTS_DIR/crash:$EXPERIMENTS_DIR/ipc-ping:$KERNEL_BUILD_DIR}"
